...
public class Menu {
    ...
    public void getPlayerStatus(Player player, int gameCurrentTurn) {
        ...
        System.out.println(player.getPlayerName() +
                        ...
                        " - Available food: - hay " +
                        player.getPlayerFood(hay) +"kg+   Meat "+
                player.getPlayerFood(meat)+"kg" + "  Milk " +
                        player.getPlayerFood(milk)+"L" + "  Seed " +
                        player.getPlayerFood(seed)+"kg" + "  Vegetables " +
                        player.getPlayerFood(vegetables) +"Kg");
